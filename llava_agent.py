...
result = img_review(
    "https://cdn.discordapp.com/attachments/1083723388712919182/1089909178266558554/HannaD_A_captivating_digital_artwork_features_a_red-haired_girl_664d73dc-b537-490e-b044-4fbf22733559.png",
    "a llama driving a car",
)
print(result)
...
img_gen_assistant = AssistantAgent(
    ...
    you will use text_to_image_generation function to generate image with prompt provided, 
...
img_critic_assistant = AssistantAgent(
    name="img_critic",
    system_message="""You are an AI image critique, you will use img_review function
     to review the image generated by the text_to_img_prompt_expert against the original prompt, 
     and provide feedback on how to improve the prompt.""",
    llm_config=llm_config_assistants,
    function_map={
        "image_review": img_review,
        "text_to_image_generation": text_to_image_generation,
